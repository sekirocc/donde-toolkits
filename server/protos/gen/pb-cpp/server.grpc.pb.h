...
class FaceService final {
 public:
  ...
  typedef WithAsyncMethod_Detect<WithAsyncMethod_ExtractFeature<Service > > AsyncService;
  template <class BaseClass>
  ...
  typedef WithCallbackMethod_Detect<WithCallbackMethod_ExtractFeature<Service > > CallbackService;
  ...
  typedef WithStreamedUnaryMethod_Detect<WithStreamedUnaryMethod_ExtractFeature<Service > > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_Detect<WithStreamedUnaryMethod_ExtractFeature<Service > > StreamedService;
};
