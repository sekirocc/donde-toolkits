...
class Coordinator {
  public:
    ...
    virtual std::vector<search::DBItem> ListUserDBs() = 0;
...
class ShardManager {
  ...
  public:
    ...
    virtual std::string CreateShard(search::DBShard shard_info) = 0;

    virtual RetCode UpdateShard(search::DBShard shard_info) = 0;
};
